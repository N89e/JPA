# 🎛️ Configuration Centralisée des Sections

**Gestion facile & centralisée de toutes les sections!**

**Fichier:** `frontend/src/config/sectionsConfig.js`
...
**Fichier clé:** `frontend/src/config/sectionsConfig.js`
