# 🏗️ Architecture Frontend - Lazy Loading

**Dernière mise à jour:** 22 avril 2026  
**Optimisation:** Chargement dynamique des sections  
...
Voir `sectionLoader.js` pour modifier les comportements de chargement.

---

**Dernière mise à jour:** 22 avril 2026  
**API:** Intersection Observer  
**Performance:** Lazy Loading au scroll
